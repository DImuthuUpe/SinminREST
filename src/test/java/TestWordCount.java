...
public class TestWordCount {
    ...
    public void testWordCount() throws Exception {
        ...
        WordCountR resp = client.getWordCount("NEWS", 2012);
        assertEquals(resp.getCount(),4582);
        resp = client.getWordCount( 2012);
        assertEquals(resp.getCount(),4582);
        resp = client.getWordCount("NEWS");
        assertEquals(resp.getCount(),4582);
        resp = client.getWordCount();
        assertEquals(resp.getCount(),4582);
    }
}
